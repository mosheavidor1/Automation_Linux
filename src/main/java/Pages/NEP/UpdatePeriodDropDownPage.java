...
//check for updates (change the Update period). clicks on the Drop Down
    ...
    public class UpdatePeriodDropDownPage extends GenericPage {
      ...
      public static final By ChoosePeriod = By.xpath("/html/body/div/div[46]/div/div/div/div[2]/div/div[2]/div/material-list/div/div[2]/twa-select-dropdown-item/span");





        @FindBy(how = How.XPATH, using = "/html/body/div/div[46]/div/div/div/div[2]/div/div[2]/div/material-list/div/div[2]/twa-select-dropdown-item/span")
